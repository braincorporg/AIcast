...
function_descriptions = [
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "blogPost": {
                    "type": "string",
                    "description": "Create a blog post based on all the informations you have about that subject, including keywords and technical details. Don't break line, make it one big paragraph."
                },
            },
